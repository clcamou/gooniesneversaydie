  ...
  'student_responses',
  {
    ...
    classMethods: {
      getResponsesForAssignment: function(student, assignment_id){
        return this.findAll({where: {user_id: student, assignment_id: assignment_id}})
      },
      gradeResponseForAssignment: function(student, assignment_id, question_number, response_grade){
        return this.update({response_grade: response_grade}, {
          where: {
            user_id: student,
      ...
      addResponseToAssignment: function(student, assignment_id, question_number, question_response){
        return this.create({assignment_id: assignment_id, user_id: student, question_number: question_number, question_response: question_response})
      ...
      editResponse: function(question_response, user_id, assignment_id, question_number){
        return this.update({question_response: question_response}, {
          where: {
            user_id: student,
            assignment_id: assignment_id,
            question_number: question_number
